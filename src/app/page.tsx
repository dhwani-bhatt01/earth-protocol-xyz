		...
		<>
			<div className="dsp mb-4">
				...
				<div>
					...
					<img src={externalLinkGreenImg.src} alt="externalLink" />
				</div>
				<div>
					<img
		...
		<>
			...
			>
				<div className="text-center mb-5">
					<img src={popupLogoIm.src} alt="chain" className="gif_wdth" />
			...
			>
				<div className="text-center mb-5">
					<img src={popupLogoIm.src} alt="chain" className="gif_success_wdth" />
